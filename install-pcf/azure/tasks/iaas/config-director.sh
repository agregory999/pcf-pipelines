...
networks_configuration=$(
  jq -n \
    --arg infra_subnet_iaas "${AZURE_NETWORK_RESOURCE_GROUP}/${AZURE_TERRAFORM_PREFIX}-virtual-network/${AZURE_TERRAFORM_PREFIX}-opsman-and-director-subnet" \
    ...
    --arg ert_subnet_iaas "${AZURE_NETWORK_RESOURCE_GROUP}/${AZURE_TERRAFORM_PREFIX}-virtual-network/${AZURE_TERRAFORM_PREFIX}-ert-subnet" \
    ...
    --arg services1_subnet_iaas "${AZURE_NETWORK_RESOURCE_GROUP}/${AZURE_TERRAFORM_PREFIX}-virtual-network/${AZURE_TERRAFORM_PREFIX}-services-01-subnet" \
    ...
    --arg dynamic_services1_subnet_iaas "${AZURE_NETWORK_RESOURCE_GROUP}/${AZURE_TERRAFORM_PREFIX}-virtual-network/${AZURE_TERRAFORM_PREFIX}-dynamic-services-subnet" \
